...
const Footer = () => {
  const services = [
    ...
    { label: "Discord Bot Hosting", href: "/discord-bots" },
    { label: "VPS Hosting", href: "/vps" },
    { label: "Web Hosting", href: "/web-hosting" },
    { label: "Free Hosting", href: "/free-hosting" },
  ];

  const company = [
    { label: "Status", href: "/status" },
    { label: "Control Panel", href: config.panelUrl, external: true },
    { label: "VPS Panel", href: config.vpsPanel, external: true },
  ];
    ...
    <footer className="py-16 border-t border-border bg-card/50">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              {config.description}. High-performance servers, 
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Domain: <span className="text-primary font-medium">{config.domain}</span>
          </p>
        </div>
      </div>
    </footer>
